...
'''
Numpy is a great framework, 
but it cannot utilize GPUs to accelerate its numerical computations. 
...
Also unlike numpy, PyTorch Tensors can utilize GPUs to 
accelerate their numeric computations. To run a PyTorch Tensor on GPU, 
...
'''
numpy不能utilize战术显卡，因此Tensor横空出世
感觉基本上是把example01的numpy代码换成了torch
'''
